# Barony Save Editor (JSON Field Editor)

## Purpose
- Primary: compare Barony host vs client saves and resolve mismatches quickly.
...
- Changelog tracking: project changes are recorded in `CHANGELOG.md`.
